...
const about = {
	...
	info: [
		{
			fieldName: 'Имя:',
			fieldValue: 'Арсений Банников',
		},
		{
			fieldName: 'Телефон:',
			fieldValue: '+7 (982)-963-29-75',
		},
		{
			fieldName: 'Опыт:',
			fieldValue: '2 года',
		...
		{
			fieldName: 'Email:',
			fieldValue: 'bannikov.arseniyy@rambler.ru',
		},
		{
			fieldName: 'Фриланс:',
			fieldValue: 'Доступен',
	...
	items: [
		{
			...
			position: 'Профессия Веб-разработчик',
			duration: 'февраль 2022 - февраль 2023',
		},
	],
}
